                    ...
                    <div class="row" style="margin-top: 15px">
                        ...
                        <div class="row" style="margin-top: 15px">
                            <div class="col-md-8">
                                ...
                                <input type="text" id="addres_uz" class="form-control" name="addres_uz">
                        ...
                        <div class="row" style="margin-top: 15px">
                            <div class="col-md-8">
                                ...
                                <input type="text" id="addres_ru" class="form-control" name="addres_ru">
                        ...
                        <div class="row" style="margin-top: 15px">
                            <div class="col-md-8">
                                ...
                                <input type="text" id="addres_en" class="form-control" name="addres_en">
                        ...
                        <div class="row" style="margin-top: 15px">
                            <div class="col-md-3">
                                ...
                                <input type="text" id="second_number" class="form-control" name="second_number">
                        ...
                        <div class="row" style="margin-top: 15px">
                            <div class="col-md-3">
                                ...
                                <input type="text" id="second_gmail" class="form-control" name="second_gmail">
