              ...
              <section class="container_in">
                <div class="header_in__item__list">
                  <ul class="header_in__menu">
                    ...
                    <li>
                      <a href="#!" class="header_in__menu__link">@lang('main.cable_trays')</a>
                    </li>
            ...
            <section class="container_in">
              <div class="products__item">
                ...
                <div class="products__item__list">
                  @foreach($portfolio2s as $portfolio2)
                    
                  <section class="products__item__wowjs wow">
                    <div class="products__list__item">
                      <a href="{{ route('portfolio3', $portfolio2->{'slug_' . app()->getLocale()}) }}" class="products__portfolio__link">
                        <div class="products__list__img">
                          <img src="{{ asset($portfolio2->image) }}" alt="products" />
                          <h3 class="products__list__title__h3">{{ $portfolio2->{'title_' . app()->getLocale()} }}</h3>
              ...
              <section class="container_in">
                <div>
                  <ul class="products__menu">
                    <li class="wow">
                      <a href="{{ route('products3') }}" class="products__menu__link">@lang('main.aboutproducts')</a>
                    </li>
  
                    <li class="wow">
                      <a href="{{ route('portfolios3') }}" class="products__menu__link active">
                        @lang('main.portfolio')
                      </a>
                    </li>
                  </ul>
