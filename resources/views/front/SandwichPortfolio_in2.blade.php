          ...
          <section class="container_in">
            <div class="header_in__item__list">
              <ul class="header_in__menu">
                <li>
                  <a href="{{ route('portfolios2') }}" class="header_in__menu__link">@lang('main.portfolio')</a>
                </li>

                <li>
                  <a class="header_in__menu__link">{{ $portfolio1->{'title_' . app()->getLocale()} }}</a>
                </li>
              </ul>
      ...
      <div class="products__list__scrull">
        <section class="container_in">
          <div class="products__item clearfix">
            <section>
              <h2 class="products__title__h2">{{ $portfolio1->{'title_' . app()->getLocale()} }}</h2>
          ...
          <section class="container_in">
            <section class="products__foto__video__all">
              <div class="products__item__list products__foto active" data-item="fotoItem">
                @foreach($portfolioimage1s as $portfolioimage1)
                <section class="products__item__wowjs wow">
                  <div class="products__list__item">
                    <a href="{{ asset($portfolioimage1->image) }}" data-fancybox="gallery">
                      <div class="products__foto__item__img">
                        <img src="{{ asset($portfolioimage1->image) }}" alt="gallery" />
              ...
              <div class="products__item__list products__foto" data-item="videoItem">
                ...
                <section class="products__item__wowjs wow">
                  <div class="products__video__item">
                    <p class="text-center">
                      <a data-fancybox class="about__item__video" href="{{ $portfoliovideo1->video }}">
                        <section>
                          <h3 class="products__list__title__h3">{{ $portfoliovideo1->{'title_' . app()->getLocale()} }}</h3>
                          <img class="inline" src="{{ asset($portfoliovideo1->image) }}" alt="videoItem" />
                          <!-- play start -->
