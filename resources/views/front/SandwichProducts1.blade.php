                  ...
                  <section class="products__item__wowjs wow">
                    <div class="products__list__item">
                      <div class="products__list__img">
                        ...
                        <h3 class="products__list__title__h3">{{ $metal->{'title_' . app()->getLocale()} }}</h3>
                        <h4 class="products__list__title__h4">{{ $metal->{'info_' . app()->getLocale()} }}</h4>
                      </div>
  
                      <a href="{{ route('product1', $metal->{'slug_' . app()->getLocale()}) }}" class="products__list__link">
                        @lang('main.more')
