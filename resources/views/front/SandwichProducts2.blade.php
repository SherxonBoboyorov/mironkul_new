                  ...
                  <section class="products__item__wowjs wow">
                    <div class="products__list__item">
                      <div class="products__list__img">
                        ...
                        <h3 class="products__list__title__h3">{{ $product1->{'title_' . app()->getLocale()} }}</h3>
                        <h4 class="products__list__title__h4">{{ $product1->{'info_' . app()->getLocale()} }}</h4>
                      </div>
  
                      <a href="{{ route('product2', $product1->{'slug_' . app()->getLocale()}) }}" class="products__list__link">
                        @lang('main.more')
              ...
              <section class="container_in">
                <div>
                  <ul class="products__menu">
                    <li class="wow">
                      <a href="{{ route('products2') }}" class="products__menu__link active">
                        @lang('main.aboutproducts')
                      </a>
                    </li>
  
                    <li class="wow">
                      <a href="{{ route('portfolios2') }}" class="products__menu__link"> @lang('main.portfolio') </a>
                    </li>
                  </ul>
                </div>
              </section>
