            ...
            <section class="container_in">
              <div class="header_in__item__list">
                <ul class="header_in__menu">
                  ...
                  <li>
                    <a class="header_in__menu__link">{{ $product1->{'title_' . app()->getLocale()} }}  {{ $product1->{'info_' . app()->getLocale()} }}</a>
                  </li>
                </ul>
          ...
          <section class="container_in">
            <div class="products__item clearfix">
              <div class="products__item__img">
                <img src="{{ asset($product1->image) }}" alt="products" />
              </div>

              <section>
                <h2 class="products__title__h2">{{ $product1->{'title_' . app()->getLocale()} }}</h2>
                <h4 class="products__iten__title">{{ $product1->{'info_' . app()->getLocale()} }}</h4>
                <div class="products__item__text">
                  <p>
                    {!! $product1->{'description_' . app()->getLocale()} !!}
                  </p>
                </div>
              </section>
            </div>
          ...
          <div class="products__foto__video">
            <section class="container_in">
              <div class="products__foto__video__list">
                ...
                <a href="{{ route('portfolios2') }}" class="products__item__video wow">
                  <div class="products__foto__img">
                    <i class="far fa-images"></i>
                  </div>
            ...
            <section class="container_in">
              <section class="products__foto__video__all">
                <div class="products__item__list products__foto active" data-item="fotoItem">
                  @foreach($productimage1s as $productimage1)
                  <section class="products__item__wowjs wow">
                    <div class="products__list__item">
                      <a href="{{ asset($productimage1->image) }}" data-fancybox="gallery">
                        <div class="products__foto__item__img">
                          <img src="{{ asset($productimage1->image) }}" alt="gallery" />
                ...
                <div class="products__item__list products__foto" data-item="videoItem">
                  @foreach($productvideo1s as $productvideo1)
                  
                  <section class="products__item__wowjs wow">
                    <div class="products__video__item">
                      <p class="text-center">
                        <a data-fancybox class="about__item__video" href="{{ $productvideo1->video }}">
                          <section>
                            <h3 class="products__list__title__h3">{{ $productvideo1->{'title_' . app()->getLocale()} }}</h3>
                            <img class="inline" src="{{ asset($productvideo1->image) }}" alt="videoItem" />
                            <!-- play start -->
