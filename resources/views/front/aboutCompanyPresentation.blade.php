                ...
                <section class="container_in">
                    <div class="header_in__item__list">
                        ...
                        <ul class="header_in__menu">
                            ...
                            <li>
                                <a href="{{ route('about') }}" class="header_in__menu__link">@lang('main.contacts')</a>
                            </li>

                            <li>
                              <a class="header_in__menu__link">@lang('main.presentation')</a>
                            </li>
                        </ul>
      ...
      <div class="products__list__scrull">
        <section class="container_in">
          <div class="products__aboutCompany__item">
            <h2 class="products__title__h2">@lang('main.presentation')</h2>
          </div>
        </section>
